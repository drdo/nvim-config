...
syn keyword hsStructure class data deriving instance default where template interface
...
if exists("hs_highlight_types")
  ...
  syn keyword hsType Party Int Decimal Bool Action Void Text Date Time RelTime ContractId
endif
if exists("hs_highlight_more_types")
  " Types from the standard prelude libraries.
  syn keyword hsType Option Either
  syn keyword hsMaybe None 
